...
const SEED_PARTNERS: SyncedPartner[] = [
  ...
  { said: '999015', storeName: 'Dev Store — fresh accept + single spin (10 orders)', tier: 'Tier 3', orders: 10 },
  { said: '999016', storeName: 'Dev Store — fresh accept + full 4-milestone run (40 orders)', tier: 'Tier 2', orders: 40 },
